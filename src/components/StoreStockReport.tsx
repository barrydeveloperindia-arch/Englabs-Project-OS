                ...
                <div className="flex items-center gap-4">
                    <div className="relative">
                        ...
                        <input 
                            ...
                            className="bg-slate-50 border border-slate-100 rounded-xl py-2.5 pl-11 pr-4 text-xs font-bold focus:border-indigo-500 outline-none w-64"
                            value={searchQuery}
                    ...
                    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="bg-white rounded-[2.5rem] p-10 border border-slate-100 shadow-xl relative overflow-hidden">
                            ...
                            <div className="relative flex justify-between items-start">
                                <div>
                                    <button onClick={() => setView('FOLDERS')} className="text-[10px] font-black text-indigo-500 uppercase tracking-widest mb-4 hover:underline flex items-center gap-2">
                                        ← Back to Archive
                                    </button>
