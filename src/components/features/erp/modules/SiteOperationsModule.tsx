...
export const SiteOperationsModule: React.FC = () => {
    const [activeTab, setActiveTab] = useState('Active Sites');

    return (
        <div className="space-y-6 animate-fade-in">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-black text-slate-800">Site Operations</h1>
            ...
            <div className="flex gap-2 border-b border-slate-200 pb-px overflow-x-auto dark-scrollbar">
                {['Active Sites', 'Safety Audits', 'Resource Allocation'].map(tab => (
                    <button 
                        key={tab}
