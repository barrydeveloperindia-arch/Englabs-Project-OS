...
export const MarketingSalesModule: React.FC = () => {
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-black text-slate-800">Marketing & Sales</h1>
            ...
            <div className="flex gap-2 border-b border-slate-200 pb-px overflow-x-auto dark-scrollbar">
                {['Campaigns', 'Leads pipeline', 'Conversions'].map(tab => (
                    <button 
                        key={tab}
