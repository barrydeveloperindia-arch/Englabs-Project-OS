...
export const PackingDispatchModule: React.FC = () => {
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-black text-slate-800">Packing & Dispatch</h1>
            ...
            <div className="flex gap-2 border-b border-slate-200 pb-px overflow-x-auto dark-scrollbar">
                {['Packing List', 'Ready for Dispatch', 'Dispatched'].map(tab => (
                    <button 
                        key={tab}
