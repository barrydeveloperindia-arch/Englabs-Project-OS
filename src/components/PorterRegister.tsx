...
const PorterRegister: React.FC<Props> = ({ trips, onNewTrip, onUpdateTrip, onDeleteTrip }) => {
    ...
    return (
        <div className="flex-1 flex flex-col min-w-0 bg-[#F8FAFC]">
            {/* HEADER */}
            <header className="h-24 bg-white border-b border-slate-100 flex items-center justify-between px-10 shrink-0 sticky top-0 z-40 shadow-sm">
                    ...
                    <div>
                        <h1 className="text-xl font-black text-slate-900 tracking-tight flex items-center gap-2">
                            ...
                            <div className="flex gap-2">
                                <span className="text-[10px] font-black bg-emerald-50 text-emerald-500 px-2 py-1 rounded-md border border-emerald-100 flex items-center gap-1">
                                    <Shield className="w-3 h-3" /> PROTECTION ACTIVE
                                </span>
                                <span className="text-[10px] font-black bg-slate-50 text-slate-500 px-2 py-1 rounded-md border border-slate-100">AGENT v1.0</span>
                            </div>
                        </h1>
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">KM-Wise Logistics & Delivery Ledger</p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button 
                        ...
                        className="bg-[#0F172A] text-emerald-500 hover:bg-slate-800 font-black px-6 py-3.5 rounded-xl flex items-center gap-2 text-[10px] uppercase tracking-widest transition-all shadow-lg shadow-slate-900/10"
                    >
                ...
                <div className="fixed inset-0 bg-slate-900/90 backdrop-blur-xl z-[100] flex items-center justify-center p-6">
                    <div className="bg-white rounded-[3rem] w-full max-w-2xl overflow-hidden shadow-2xl border-8 border-slate-50">
                        <div className="p-12">
                            ...
                            <div className="flex justify-between items-center bg-[#0F172A] p-10 rounded-[2.5rem] text-white">
                                <div>
